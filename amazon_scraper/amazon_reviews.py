...
def ParseReviews(asin):
	...
	#TEMPORARY
	all_reviews_link = "https://www.amazon.com/Elizavecca-Milky-Piggy-Carbonated-Bubble/product-reviews/B00MWI2IS0/ref=cm_cr_arp_d_paging_btm_557?ie=UTF8&pageNumber=557&reviewerType=all_reviews"
	...
	while len(parser.xpath(NEXT_PAGE)) != 0:
		counter += 1
		...
		next_page = parser.xpath(NEXT_PAGE)[0]
		...
		headers = {'User-Agent': random.choice(list_of_users)}
